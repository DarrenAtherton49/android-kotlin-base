package com.atherton.sample.util.network.retrofit
...
class KotlinRxJava2CallAdapterFactory private constructor() : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        check(returnType is ParameterizedType) {
            "${rawType.simpleName} return type must be parameterized as ${rawType.simpleName}<Foo> or " +
                "${rawType.simpleName}<? extends Foo>"
        }
        ...
        check(observableEmissionType is ParameterizedType) {
